...
#define HOUSTON_STATUS_ENCODED_COMMAND (1 << 2)
...
#define HOUSTON_STATUS_WAIT_ENCODED_COMMAND() houston_status_waitStatus(HOUSTON_STATUS_ENCODED_COMMAND, pdTRUE);
#define HOUSTON_STATUS_SET_ENCODED_COMMAND() houston_status_setStatus(HOUSTON_STATUS_ENCODED_COMMAND)
